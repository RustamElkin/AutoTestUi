...
public class ContingentArchiveExpelledStudentsPage {
    ...
    private SelenideElement retirementDateTable = $(byXpath("//th[contains(text(),'Дата выбытия')]"));                  //'Дата выбытия'
    ...
    //Таблица операции
    private SelenideElement viewBtn = $(byXpath("//tr[1]/td[@data-table-head=\"Операции\"]//a[@title=\"Посмотреть\"]")); // Кнопка просмотра, первой строки в таблице
