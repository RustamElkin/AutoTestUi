...
public class DocumentFlowLetterCreateAndSubmitPage {
    ...
    // Тайтл
    private SelenideElement titleToPage = $(byXpath("//h1[contains(text(),'Отправить письмо')]"));
    ...
    private SelenideElement submitBtn = $(byXpath("//button//div[contains(text(),'Отправить письмо')]/../.."));                // кнопка 'Отправить письмо'
