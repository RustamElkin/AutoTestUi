package pages;// Мониторинг_Онлайн занятия
// МОН РК
...
public class MonitoringOnlineLessonsPage {
    ...
    private SelenideElement titleRegionList = $x("//h3/span[contains(text(),'Туркестанская область')]");
    ...
    private ElementsCollection regionList = $$x("//h3/span");                                                                     // 'Список регионов'
