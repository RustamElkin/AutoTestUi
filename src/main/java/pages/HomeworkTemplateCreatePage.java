package pages;// Дистанционное обучение_Создание шаблона задания
...
public class HomeworkTemplateCreatePage {
    ...
    public HomeworkTemplateCreatePage checkTitleToPage() {
