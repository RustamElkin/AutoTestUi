package pages;// Документооборот_Оставить заявку
...
public class DocumentFlowStatementsCreatePage {
    ...
    public DocumentFlowStatementsCreatePage checkTitleToPage() {
        titleToPage.shouldBe(Condition.visible).shouldHave(text("Оставить заявку"));
        return this;
    }
