package pages;// Мониторинг_Гос. услуг_Архив
//  /ru/tko/control/monitoring/gov-service-statements?tab=archived
...
public class MonitoringGovServiceStatementArchivePage {
    ...
    private SelenideElement applicationsTab = $x("//span[contains(text(),'Заявки')]/parent::a[@href=\"/ru/tko/control/monitoring/gov-service-statements\"]");          // Таб "Заявки"
    private SelenideElement statisticsTab = $x("//span[contains(text(),'Статистика')]/parent::a[@href='/ru/tko/control/monitoring/gov-service-statement/statistic']"); // Таб "Статистика"                                                                                 // Таб "Назад"
    private SelenideElement archiveTab = $x("//span[contains(text(),'Архив')]/parent::a[@href=\"/ru/tko/control/monitoring/gov-service-statements?tab=archived\"]");   // Таб "Архив"
