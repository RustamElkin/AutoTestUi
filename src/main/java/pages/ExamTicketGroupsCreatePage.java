package pages;// Создание группы экзаменационных билетов
...
public class ExamTicketGroupsCreatePage {
    ...
    public ExamTicketGroupsCreatePage checkElementsToPage() {
        titleToPage.shouldBe(Condition.visible).shouldHave(text("Создание группы экзаменационных билетов"));
