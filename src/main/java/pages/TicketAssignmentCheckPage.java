...
public class TicketAssignmentCheckPage {
    ...
    // Тайтлы
    private SelenideElement studentAnswer                 = $x("//h3/span[contains(text(),Ответ)]");
    private SelenideElement checking                      = $x("//h3/span[contains(text(),Оценивание)]");
    ...
    public TicketAssignmentCheckPage checkTitlesToPage() {
        studentAnswer.shouldBe(Condition.visible);
        checking.shouldBe(Condition.visible);
        return this;
    }
