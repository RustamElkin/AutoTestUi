...
public class ViewAnnualArchiveExamPage {
    ...
    // Тайтлы таблиц
    private SelenideElement generalInformationTable = $x("//h3[contains(text(),'Общие сведения')]");         // 'Общие сведения'
    private SelenideElement memberTable             = $x("//h3[contains(text(),'Участники')]");              // 'Участники'
